...
public class EmployeeController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved attendance records", content = @Content(array = @ArraySchema(schema = @Schema(implementation = Attendance.class)))),
        ...
        @Operation(summary = "Get Leave Request Status", description = "Retrieves the status of annual and accidental leave requests submitted by the authenticated employee during the given month. "
                        + "Uses Status_leaves table-valued function. Returns request_ID, date_of_request, and status (Approved/Pending/Rejected).")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved leave statuses", content = @Content(array = @ArraySchema(schema = @Schema(implementation = LeaveStatus.class)))),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - JWT token missing or invalid"),
                        @ApiResponse(responseCode = "500", description = "Database error - SQL exception occurred", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved performance records", content = @Content(array = @ArraySchema(schema = @Schema(implementation = Performance.class)))),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - JWT token missing or invalid"),
                        @ApiResponse(responseCode = "500", description = "Database error - SQL exception occurred", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved payroll records", content = @Content(array = @ArraySchema(schema = @Schema(implementation = PayRoll.class)))),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - JWT token missing or invalid"),
                        @ApiResponse(responseCode = "500", description = "Database error - SQL exception occurred", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved deductions", content = @Content(array = @ArraySchema(schema = @Schema(implementation = Deduction.class)))),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - JWT token missing or invalid"),
                        @ApiResponse(responseCode = "500", description = "Database error - SQL exception occurred", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
        })
        ...
        public void submit_annual(
                        Principal p,
                        @Parameter(description = "Annual leave submission with replacement ID, start date, and end date", required = true) @Valid @RequestBody SubmitAnnual submitAnnual) {
        ...
        public void submit_compensation(
                        Principal p,
                        @Parameter(description = "Compensation leave submission with comp date, reason, original workday, and replacement ID", required = true) @Valid @RequestBody Submitcomp submitCompensation) {
        ...
        public void submit_accidental(
                        Principal p,
                        @Parameter(description = "Accidental leave submission with start and end date", required = true) @Valid @RequestBody SubmitAccidental submitAccidental) {
        ...
        public void submit_unpaid(
                        Principal p,
                        @Parameter(description = "Unpaid leave submission with start date, end date, document, and filename", required = true) @Valid @RequestBody Submitunpaid submitUnpaid) {
        ...
        public void submit_medical(
                        Principal p,
                        @Parameter(description = "Medical leave submission with start/end date, type (sick/maternity), insurance status, disability details, and document", required = true) @Valid @RequestBody SubmitMedical submitMedical) {
        ...
        public void upperboard_approve_annual(
                        Principal p,
                        @Parameter(description = "Approval request with request ID and replacement ID", required = true) @Valid @RequestBody Upperboardapproval uba) {
        ...
        public void dean_andHR_evaluation(
                        @Parameter(description = "Evaluation with employee ID, rating (1-5), comment, and semester", required = true) @Valid @RequestBody Eval eval) {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Successfully retrieved list of managed employees", content = @Content(array = @ArraySchema(schema = @Schema(implementation = Employee.class)))),
                        @ApiResponse(responseCode = "401", description = "Unauthorized - JWT token missing or invalid"),
                        @ApiResponse(responseCode = "500", description = "Database error - SQL exception occurred", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
        })
